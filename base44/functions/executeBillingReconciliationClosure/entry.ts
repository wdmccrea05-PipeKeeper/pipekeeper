  ...
  try {
    ...
    return Response.json({
      ...
      provider_inventory: {
        ...
        stripe_current_subscriptions: currentLedger.length,
        stripe_historical_subscriptions: providerLedger.length - currentLedger.length,
      ...
      data_quality: {
        ...
        unresolved_current_plans: currentLedger.filter((l: any) => l.resolved_plan.classification === "UNRESOLVED").length,
