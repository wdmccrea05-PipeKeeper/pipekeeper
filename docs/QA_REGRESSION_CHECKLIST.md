...
2. Add 6 pipes (free limit = 5)
3. Should see error: "Free tier limited to 5 pipes."
4. Add 11 tobacco blends (free limit = 10)
5. Should see error: "Free tier limited to 10 tobacco blends."
6. Create 51 usage logs (free limit = 50)
7. Should see error: "Free tier limited to 50 usage logs."
...
4. After trial expires:
   ...
   - Pro features locked
   - Free features still work (5 pipes, 10 blends, 50 logs)
