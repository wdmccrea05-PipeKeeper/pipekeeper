      ...
      items: [
        {
          ...
          answer: canShowPurchaseUI
            ? "New users get 7 days of full Premium access to try all features. After the trial, you can subscribe to continue using Premium features."
            : "Trial availability may vary by account. Premium upgrades aren't available in the companion app. If you already have Premium, sign in with the same account to access your features."
        },
        {
          question: "How much does Premium cost?",
          answer: canShowPurchaseUI
            ? "PipeKeeper Premium is $1.99/month or $19.99/year. Plans include Premium features and renew until canceled."
            : "Premium upgrades aren't available in the companion app. If you already have Premium, sign in with the same account and your features will unlock automatically."
        },
        {
          question: "What happens if I cancel my subscription?",
          answer: canShowPurchaseUI
            ? "You'll keep Premium access until the end of your billing period. After that, Premium features lock, but your collection data remains available."
            : "If your Premium access ends, Premium features lock but your collection data remains available. Subscription management isn't available in the companion app."
        },
        {
