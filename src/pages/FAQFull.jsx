  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1A2B3A] via-[#243548] to-[#1A2B3A]">
      ...
      <Section title="Features & Tools">
        ...
        <Q id="verified-measurements" q="Can I find verified manufacturer specifications?">
          Yes, as a secondary option. Go to AI Updates → 'Find Verified Manufacturer Specs'. This searches manufacturer catalogs and databases but only works for some production pipes. Many artisan and estate pipes won't have verified specs available. If none are found, use 'Analyze Geometry from Photos' (the primary tool) instead. Both tools only update missing or 'Unknown' fields - never overwrite your data.
        </Q>
      ...
      <Section title="Plans & Subscriptions">
        ...
        <Q id="pro-ai-identification" q="Pro: AI Identification Tools">
          ...
          <ul className="list-disc ml-6 mt-2 space-y-1">
            ...
            <li><b>Analyze pipe geometry from photos</b> (shape, bowl style, shank shape, bend, size class) - primary classification tool</li>
            <li>Find verified manufacturer specs (optional, works for some production pipes only)</li>
