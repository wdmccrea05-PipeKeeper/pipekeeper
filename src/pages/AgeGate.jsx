      ...
      <Card className="max-w-md w-full bg-[#243548]/80 border-[#8b3a3a]/60">
        <CardHeader>
          <CardTitle className="text-2xl font-semibold text-[#e8d5b7] text-center">
            {t("ageGate.title","Adults Only")}
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="space-y-4 text-[#e8d5b7]/90">
            <p className="text-center">
              {t("ageGate.intendedForAdults","PipeKeeper is intended for adult users only.")}
            </p>
            <p className="text-sm text-center text-[#e8d5b7]/70">
              {t("ageGate.disclaimer","This app is a collection management tool for pipe smoking enthusiasts. It does not sell or facilitate the purchase of tobacco products.")}
            </p>
          </div>
          <Button 
            ...
            onClick={onConfirm}
          >
            {t("ageGate.confirmAge","I confirm I am of legal age")}
          </Button>
        </CardContent>
      </Card>
    </div>
