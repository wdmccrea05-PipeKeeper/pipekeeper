...
export default function UserReport() {
  ...
  function exportCSV() {
    const metricRows = [
      ...
      ['Paid Accounts',            accounts.paid     ?? ''],
      ['Free Accounts',            accounts.free     ?? ''],
      ...
      ['New Accounts — Today',     accounts.newAccounts?.today   ?? ''],
      ...
      // Subscriptions
      ['--- SUBSCRIPTIONS ---', ''],
      ['Total Active Paid Subscriptions', subscriptions.totalActivePaid ?? ''],
      ['Monthly Subscriptions',          subscriptions.monthly ?? ''],
      ['Annual Subscriptions',           subscriptions.annual  ?? ''],
      ['PipeKeeper',                     subscriptions.byProduct?.pipekeeper    ?? ''],
      ...
      // Renewal Revenue
      ['--- RENEWAL REVENUE ---', ''],
      ['Renewal Revenue — This Week (customers)',      renewalRevenue.week?.customers     ?? ''],
      ['Renewal Revenue — This Week (subs)',           renewalRevenue.week?.subscriptions ?? ''],
      ['Renewal Revenue — This Week ($)',             `$${(renewalRevenue.week?.revenue    ?? 0).toFixed(2)}`],
      ['Renewal Revenue — This Month (customers)',     renewalRevenue.month?.customers     ?? ''],
      ['Renewal Revenue — This Month (subs)',          renewalRevenue.month?.subscriptions ?? ''],
      ['Renewal Revenue — This Month ($)',            `$${(renewalRevenue.month?.revenue   ?? 0).toFixed(2)}`],
      ['Renewal Revenue — This Quarter (customers)',   renewalRevenue.quarter?.customers     ?? ''],
      ['Renewal Revenue — This Quarter (subs)',        renewalRevenue.quarter?.subscriptions ?? ''],
      ['Renewal Revenue — This Quarter ($)',          `$${(renewalRevenue.quarter?.revenue  ?? 0).toFixed(2)}`],
      ['Renewal Revenue — This Year (customers)',      renewalRevenue.year?.customers     ?? ''],
      ['Renewal Revenue — This Year (subs)',           renewalRevenue.year?.subscriptions ?? ''],
