/**
 * PipeKeeper Icons — reusable SVG icon components
 * 
 * PipeIcon is now deprecated — use the canonical version from @/components/icons/PipeIcon instead.
 * For backward compatibility, this file re-exports PipeIcon from the canonical location.
 */

import PipeIcon from './PipeIcon';

// Re-export canonical PipeIcon for backward compatibility
export { PipeIcon };
