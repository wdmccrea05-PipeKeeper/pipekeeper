...
export const translationsComplete = {
  ...
  es: {
    ...
    terms: {
      ...
      section1Body: 'PipeKeeper es una aplicación de gestión de colecciones e informativa enfocada en adultos diseñada para ayudar a los usuarios a catalogar, organizar y documentar pipas, inventarios de celares, accesorios y datos de colecciones relacionados. PipeKeeper no vende productos de tabaco, no facilita compras de tabaco y no procesa pedidos de tabaco.',
      section2Title: '2. Elegibilidad',
      section2Body: 'Debes ser legalmente capaz de formar un contrato vinculante en tu jurisdicción para usar el Servicio. Eres únicamente responsable de cumplir con todas las leyes locales, estatales y nacionales aplicables relacionadas con la propiedad y posesión de artículos documentados en el Servicio.',
      section3Title: '3. Cuentas',
      section3Body: 'Eres responsable de mantener la confidencialidad de tus credenciales de cuenta y de toda la actividad que ocurra en tu cuenta. Aceptas proporcionar información precisa y actualizada y mantener actualizada la información de tu cuenta.',
      section4Title: '4. Suscripciones, Características Premium y Pruebas',
      section4Intro: 'PipeKeeper puede ofrecer características Premium opcionales a través de suscripciones pagadas. El acceso de prueba limitado puede ofrecerse y se mostrará claramente en el Servicio cuando sea aplicable.',
      section4SubIntro: 'El procesamiento de suscripciones depende de la plataforma que uses:',
      ios: 'iOS',
      iosDesc: 'Las suscripciones se procesan a través del sistema de compra dentro de la aplicación de la App Store de Apple y se administran a través de tu ID de Apple.',
      webAndAndroid: 'Web y Android',
      webAndAndroidDesc: 'Las suscripciones son procesadas por PipeKeeper a través de proveedores de pago seguros de terceros y administradas a través del perfil de tu cuenta.',
      section4Closing: 'Las características, precios y disponibilidad de suscripciones pueden variar según la plataforma.',
      section5Title: '5. Facturación y Reembolsos',
      section5Body: 'El manejo de facturación y reembolsos depende de la plataforma utilizada para comprar una suscripción. Las compras en iOS están sujetas a las políticas de facturación y reembolso de Apple. Las compras en Web y Android están sujetas a los términos divulgados en el proceso de pago.',
      section7Title: '7. Contenido Generado por el Usuario y Estándares de Comunidad',
      section7Intro: 'PipeKeeper permite a los usuarios enviar y administrar contenido como notas, comentarios, imágenes, detalles de colecciones y otros datos relacionados ("Contenido Generado por el Usuario").',
      section7ZeroTolerance: 'PipeKeeper no tolera contenido objetable o comportamiento abusivo, incluyendo pero no limitado a:',
      section7Item1: 'Acoso, amenazas o discurso de odio',
      section7Item2: 'Contenido obsceno, pornográfico o sexualmente explícito',
      section7Item3: 'Contenido que promueva violencia, actividad ilegal o automutilación',
      section7Item4: 'Suplantación de identidad, spam o contenido engañoso',
      section7Enforcement: 'Nos reservamos el derecho de moderar, eliminar, restringir o eliminar permanentemente contenido o cuentas que violen estos estándares, con o sin previo aviso. Los usuarios pueden reportar contenido objetable o comportamiento abusivo a través de herramientas de reporte en la aplicación o contactando al soporte.',
      section8Title: '8. Propiedad y Derechos de Datos',
      section8Body: 'Retienes la propiedad de tu Contenido Generado por el Usuario y datos de tu colección personal. Otorgas a PipeKeeper una licencia limitada y no exclusiva para almacenar, procesar y mostrar tu contenido únicamente con el propósito de operar y mejorar el Servicio.',
      section9Title: '9. Renuncias',
      section9Body: 'El Servicio se proporciona "tal cual" y "según esté disponible". PipeKeeper puede incluir características opcionales asistidas por IA que proporcionan sugerencias e insights de mejor esfuerzo. Estas características pueden ser imperfectas y no deben considerarse como asesoramiento profesional, financiero o legal.',
      section10Title: '10. Limitación de Responsabilidad',
      section10Body: 'En la medida máxima permitida por la ley, PipeKeeper y sus afiliados no serán responsables por daños indirectos, incidentales, especiales, consecuentes o punitivos, o por pérdida de datos, ganancias o ingresos derivados del uso del Servicio.',
      section11Title: '11. Cambios en Estos Términos',
      section11Body: 'Podemos actualizar estos Términos periódicamente. Los cambios materiales se comunicarán dentro del Servicio o a través de actualizaciones publicadas. El uso continuado del Servicio constituye aceptación de los Términos actualizados.',
      section12Title: '12. Contacto',
      section12Body: 'Si tienes preguntas, inquietudes o deseas reportar violaciones, comunícate con el soporte de PipeKeeper.',
    ...
    invite: {
      apple: {
        title: 'Invita a amigos a usar PipeKeeper como gestor de colecciones e inventario de bodega.',
        whatTheyCanDo: 'Lo que pueden hacer en iOS',
        note: 'Nota: Esta compilación de iOS no incluye características de recomendación o asesoramiento de uso.',
        returnHome: 'Volver a Inicio',
        canCatalog: 'Catalogar pipas e inventario de bodega',
        canTrack: 'Rastrear cantidades, fechas de frascos, detalles de lotes y notas de almacenamiento',
        canOrganize: 'Organizar artículos con categorías, etiquetas y filtros',
        canStandardize: 'Estandarizar categorías y metadatos para registros de inventario más limpios',
      },
    },
    subscriptionCancelled: {
      title: 'Compra Cancelada',
      message: '¡Sin problemas! Puedes intentar suscribirte de nuevo en cualquier momento.',
    ...
    tobaccoLibrarySync: {
      ...
      totalBlends: 'Total de Mezclas de Tabaco',
      missingLogos: 'Logos Faltantes',
      willBeUpdated: 'Las siguientes mezclas se actualizarán:',
      syncButtonLabel: 'Sincronizar {{count}} Mezcla{{suffix}}',
  ...
  pt: {
    ...
    terms: {
      ...
      section1Body: 'PipeKeeper is an adult-focused collection-management and informational application designed to help users catalog, organize, and document pipes, cellar inventories, accessories, and related collection data. PipeKeeper does not sell tobacco products, does not facilitate tobacco purchases, and does not process tobacco orders.',
      section2Title: '2. Eligibility',
      section2Body: 'You must be legally able to form a binding contract in your jurisdiction to use the Service. You are solely responsible for complying with all applicable local, state, and national laws related to the ownership and possession of items documented within the Service.',
      section3Title: '3. Accounts',
      section3Body: 'You are responsible for maintaining the confidentiality of your account credentials and for all activity that occurs under your account. You agree to provide accurate, current information and to keep your account information updated.',
      section4Title: '4. Subscriptions, Premium Features, and Trials',
      section4Intro: 'PipeKeeper may offer optional Premium features through paid subscriptions. Limited trial access may be offered and will be clearly displayed within the Service when applicable.',
      section4SubIntro: 'Subscription processing depends on the platform you use:',
      ios: 'iOS',
      iosDesc: 'Subscriptions are processed through Apple\'s App Store In-App Purchase system and managed via your Apple ID.',
      webAndAndroid: 'Web and Android',
      webAndAndroidDesc: 'Subscriptions are processed by PipeKeeper through secure third-party payment providers and managed through your account profile.',
      section4Closing: 'Subscription features, pricing, and availability may vary by platform.',
      section5Title: '5. Billing and Refunds',
      section5Body: 'Billing and refund handling depend on the platform used to purchase a subscription. iOS purchases are subject to Apple\'s billing and refund policies. Web and Android purchases are subject to the terms disclosed at checkout.',
      section7Title: '7. User-Generated Content and Community Standards',
      section7Intro: 'PipeKeeper allows users to submit and manage content such as notes, comments, images, collection details, and other related data ("User-Generated Content").',
      section7ZeroTolerance: 'PipeKeeper has zero tolerance for objectionable content or abusive behavior, including but not limited to:',
      ...
      section7Enforcement: 'We reserve the right to moderate, remove, restrict, or permanently delete content or accounts that violate these standards, with or without notice. Users may report objectionable content or abusive behavior through in-app reporting tools or by contacting support.',
      section8Title: '8. Ownership and Data Rights',
      section8Body: 'You retain ownership of your User-Generated Content and personal collection data. You grant PipeKeeper a limited, non-exclusive license to store, process, and display your content solely for the purpose of operating and improving the Service.',
      section9Title: '9. Disclaimers',
      section9Body: 'The Service is provided "as is" and "as available." PipeKeeper may include optional AI-assisted features that provide best-effort organizational suggestions and insights. These features may be imperfect and should not be relied upon as professional, financial, or legal advice.',
      section10Title: '10. Limitation of Liability',
      section10Body: 'To the fullest extent permitted by law, PipeKeeper and its affiliates shall not be liable for any indirect, incidental, special, consequential, or punitive damages, or for loss of data, profits, or revenue arising from use of the Service.',
      section11Title: '11. Changes to These Terms',
      section11Body: 'We may update these Terms periodically. Material changes will be communicated within the Service or via posted updates. Continued use of the Service constitutes acceptance of the updated Terms.',
      section12Title: '12. Contact',
      section12Body: 'For questions, concerns, or to report violations, please contact PipeKeeper support.',
    ...
    invite: {
      apple: {
        title: 'Invite friends to use PipeKeeper as a collection and cellar inventory manager.',
        ...
        canCatalog: 'Catalog pipes and cellar inventory',
        canTrack: 'Track quantities, jar dates, lot details, and storage notes',
        canOrganize: 'Organize items with categories, tags, and filters',
        canStandardize: 'Standardize categories and metadata for cleaner inventory records',
      },
    },
    subscriptionCancelled: {
    ...
    tobaccoLibrarySync: {
      ...
      syncButtonLabel: 'Sync {{count}} Blend{{suffix}}',
      syncing: 'Syncing...',
    ...
    subscription: {
      title: 'PipeKeeper Subscriptions',
      continueUsing: 'Continue using Premium tools for your collection',
      iosAppStore: 'iOS App Store',
      purchasesHandledApple: 'Purchases and subscription management are handled through Apple.',
      upgradeAppStore: 'Upgrade (App Store)',
      statusProActive: 'Status: Pro Active ✅',
      webAndroid: 'Web & Android',
      youveHadFullAccess: "You've had full access — choose how you'd like to continue.",
      tierDescFree: 'Core cataloging for pipes and cellar items.',
      tierDescPremium: 'Premium adds expanded insights, reports, and advanced organization tools for collectors who actively manage and grow their collections.',
      tierDescPro: 'Pro is designed for collectors who want deep analytics and optional AI-assisted tools for advanced organization and analysis.',
      taglinePremium: 'For active collectors',
      taglinePro: 'For advanced collectors',
      freeFeatures: 'Basic item records, Notes and photos, Manual organization',
      premiumFeatures: 'Collection insights and summaries, Reports and exports, Advanced organization tools, Priority access to new features',
      proFeatures: 'Deep collection analytics, AI-assisted organization tools, Power-user features',
      cancelAnytime: 'Cancel anytime',
      managedThroughStripe: 'Subscription managed through Stripe',
      dataNeverAffected: 'Your existing data is never affected',
      manage: 'Manage',
      upgrade: 'Upgrade',
      selected: 'Selected',
      choose: 'Choose',
      ...
      errorStartCheckout: 'Error starting checkout. Please try again.',
      errorManagement: 'Error: Could not open subscription management',
      couldNotRefresh: 'Could not refresh. Please try again.',
      errorOccurred: 'An error occurred',
    },
    insights: {
      title: 'Collection Insights',
      ...
      exportTooltip: 'Generate exportable summaries of your collection for reference or documentation.',
      reportsSubtitle: 'Export your collection and smoking logs',
      noPairingData: 'Add pipes and tobacco to see pairings',
      noLogsData: 'Log some smoking sessions to see stats',
      noCellarData: 'Cellar tobacco to see aging information',
      noRotationData: 'No pipes to rotate',
      rotationEmptyDesc: 'Log smoking sessions to see rotation recommendations',
      rotationDesc: 'Pipes sorted by how long ago they were last smoked. Smoke the top pipes first!',
      lastSmoked: 'Last smoked',
      neverSmoked: 'Never smoked',
      noTrendsData: 'No trend data yet',
      logSessionsForTrends: 'Log smoking sessions to see trends over time',
      trendsDesc: 'Smoking sessions by date. Track your smoking patterns.',
      sessions: 'sessions',
      noData: 'No data yet',
      stats: {
        totalSessions: 'Total Sessions',
        totalBowls: 'Total Bowls',
        averageBowls: 'Avg/Session',
        mostUsedPipe: 'Top Pipe',
        mostUsedBlend: 'Top Blend',
      },
      pro: {
        trendsTitle: 'Trends Report',
      },
    ...
    tobacco: {
      ...
      addBlend: 'Add Blend',
      noBlends: 'No tobacco blends yet',
      manufacturer: 'Manufacturer',
      blendType: 'Type',
      strength: 'Strength',
      quantity: 'Quantity',
      openInventory: 'Open Inventory',
      cellaredAmount: 'Cellared',
      filter: 'Filter',
      resetFilters: 'Reset Filters',
      edit: 'Edit Blend',
      delete: 'Delete Blend',
      export: 'Export Tobacco',
      gridView: 'Grid View',
      listView: 'List View',
      sortBy: 'Sort by',
      sortDate: 'Date Added',
    ...
    invite: {
      ...
      description: 'Share PipeKeeper with other collectors',
    ...
    subscriptionCancelled: {
      ...
      willExpire: 'Your access will expire on',
      stillAccess: 'You still have access to your data',
    ...
    terms: {
      ...
      section2Body: 'You must be legally able to form a binding contract in your jurisdiction to use the Service. You are solely responsible for complying with all applicable local, state, and national laws related to the ownership and possession of items documented within the Service.',
      section3Title: '3. Accounts',
      section3Body: 'Users must be 21+ to use PipeKeeper (via age gate). Provide accurate account information. You are responsible for all activities on your account. Do not share login credentials.',
      section4Title: '4. User Content',
      section4Body: 'You retain all rights to your data. By using PipeKeeper, you grant us a license to store, display, and process your data to provide the Service.',
      section5Title: '5. Prohibited Conduct',
      section5Body: 'Do not use PipeKeeper for illegal purposes, harassment, or misrepresentation. Do not attempt to access unauthorized areas or disrupt the Service.',
      section6Title: '6. Limitation of Liability',
      section6Body: 'PipeKeeper is provided "as is." We are not liable for indirect, incidental, or consequential damages.',
      section7Title: '7. Termination',
      section7Body: 'We may terminate your account for violation of these Terms or other policies. Upon termination, your data will be available for export for 30 days.',
      section8Title: '8. Changes to Terms',
      section8Body: 'We may update these Terms at any time. Continued use of PipeKeeper constitutes acceptance of the updated Terms.',
    },
  },
  zh: {
