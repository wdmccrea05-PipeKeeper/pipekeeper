...
export const translations = {
  ...
  es: {
    home: {
      ...
      pageSubtitle: 'Catalogar, rastrear y analizar su colección de pipas y tabaco',
      loadingCollection: 'Cargando su colección...',
      pipeCollection: 'Colección de Pipas',
      trackAndValue: 'Rastree y valore sus pipas',
      pipesInCollection: 'Pipas en colección',
      collectionValue: 'Valor de colección',
      viewCollection: 'Ver colección',
      tobaccoCellar: 'Bodega de Tabaco',
      manageBlends: 'Gestionar mezclas e inventario',
      ...
      importDesc: 'Importar pipas o tabaco desde CSV o Excel',
      welcomeToCollection: 'Bienvenido a PipeKeeper',
      emptyStateDesc: 'Comience a catalogar sus pipas y mezclas de tabaco',
      addFirstPipe: 'Agregar Primera Pipa',
      addFirstBlend: 'Agregar Primera Mezcla',
      cellarBreakdown: 'Desglose de Bodega',
      noCellaredTobacco: 'Todavía no hay tabaco en bodega',
      testingPeriodTitle: 'Período de Prueba',
      importantInfo: 'Información Importante',
      testingPeriodBody: 'Actualmente se encuentra en un período de prueba.',
      testingThankYou: '¡Gracias por probar y ayudarnos a mejorar PipeKeeper!',
      gotItThanks: '¡Entendido, gracias!',
      errorTitle: 'Algo salió mal',
      errorRefresh: 'Ocurrió un error. Por favor, inténtelo de nuevo.',
      insightsError: 'Error al cargar información',
      expertTobacconistError: 'Error al cargar experto tabaquero',
    },
    auth: {
