...
const enTranslations = {
  ...
  tobacconist: {
    ...
    welcomeTitle: 'Welcome to the Expert Tobacconist',
    welcomeMessage: 'Ask questions about pairings, collection strategy, tobacco recommendations, or pipe identification.',
    generatePairingsPrompt: 'Generate optimal pipe-tobacco pairings for my collection',
    generatePairings: 'Generate Pairings',
    runOptimizationPrompt: 'Analyze my collection and suggest optimal pipe specializations',
    ...
    breakInNote: 'Generated per pipe. Updates automatically from logged sessions.',
  ...
  inventory: {
    ...
    addedToCellarFromInventory: "Added to cellar from inventory",
    tins: "Tins",
    bulk: "Bulk",
    pouches: "Pouches",
    tinSizeOz: "Tin Size (oz)",
    placeholderTinSize: "e.g., 1.75",
    totalTins: "Total Tins",
    placeholderTotalTins: "e.g., 5",
    totalQuantityOz: "Total Quantity (oz)",
    autoCalculated: "Auto-calculated",
    tinsOpen: "Tins Open",
    placeholderTinsOpen: "e.g., 1",
    tinsToCellar: "Tins to Cellar",
    placeholderTinsToCellar: "e.g., 4",
    dateCellared: "Date Cellared",
    totalBulkQuantityOz: "Total Bulk Quantity (oz)",
    placeholderBulkTotal: "e.g., 16",
    bulkOpenOz: "Bulk Open (oz)",
    placeholderBulkOpen: "e.g., 2",
    bulkToCellarOz: "Bulk to Cellar (oz)",
    placeholderBulkToCellar: "e.g., 14",
    pouchSizeOz: "Pouch Size (oz)",
    placeholderPouchSize: "e.g., 1.5",
    totalPouches: "Total Pouches",
    placeholderTotalPouches: "e.g., 3",
    pouchesOpen: "Pouches Open",
    placeholderPouchesOpen: "e.g., 1",
    pouchesToCellar: "Pouches to Cellar",
    placeholderPouchesToCellar: "e.g., 2"
  },
  cellarLog: {
