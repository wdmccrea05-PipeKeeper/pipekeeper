...
export const translationsComplete = {
  en: {
    ...
    subscription: {
      trialEndedTitle: 'Tu prueba ha finalizado',
    ...
    subscriptionCancelled: {
      ...
      message: '¡No hay problema! Puedes intentar suscribirte nuevamente en cualquier momento.',
      backToPlans: 'Volver a los Planes',
    },
    tobaccoPage: {
      failedToAddBlend: 'Error al agregar mezcla',
      successfullyUpdated: '¡Se actualizaron correctamente {{count}} mezcla{{count, plural, one {} other {s}}}!',
    ...
    pipesPage: {
      ...
      failedToAddPipe: 'Error al agregar tubería',
    },
    common: {
      done: 'Listo',
    },
