...
export const translations = {
  en: {
    ...
    helpCenter: {
      ...
      findAnswers: 'Find answers and support for using PipeKeeper',
      faq: 'FAQ',
      faqDesc: 'Common questions and answers',
      howTo: 'How-To Guides',
      howToDesc: 'Step-by-step instructions',
      troubleshooting: 'Troubleshooting',
      troubleshootingDesc: 'Solutions for common issues',
      ...
      topicPrivacy: 'Privacy & Security',
      topicSubscription: 'Subscription Tiers',
      topicDefinitions: 'Field Definitions',
      topicCommunity: 'Community Features',
      topicAI: 'AI Features',
      topicAddingPipes: 'Adding & Managing Pipes',
      topicTobaccoInventory: 'Tobacco Inventory',
      topicAIFeatures: 'Using AI Features',
      topicCellaring: 'Cellaring & Aging',
      topicExportImport: 'Export & Import',
      topicCaching: 'Login & Access',
      topicAIUpdating: 'Data & Syncing',
      topicInventory: 'Photos & Images',
      topicSearch: 'AI Features',
      topicPhotos: 'Subscription & Billing',
      topicTerms: 'Browser & Technical',
    },
    pipesExtended: {
      ...
      deletePipeDesc: 'This action cannot be undone.',
    },
    tobaccoExtended: {
      ...
      deleteBlendDesc: 'This action cannot be undone.',
    },
    formsExtended: {
      notes: 'Notes',
    ...
    pipesPage: {
      ...
      noMatchSearch: 'No pipes match your search',
    ...
    tobaccoPage: {
      ...
      noMatchSearch: 'No blends match your search',
  ...
  es: {
    ...
    pipes: { search: 'Buscar', filter: 'Filtrar', shape: 'Forma', material: 'Material', allShapes: 'Todas las formas', allMaterials: 'Todos los materiales', gridView: 'Vista de Cuadrícula', listView: 'Vista de Lista' },
    tobacco: { allTypes: 'Todos los tipos', allStrengths: 'Todas las fuerzas', search: 'Buscar' },
    common: { loading: 'Cargando...', refresh: 'Actualizar', cancel: 'Cancelar', save: 'Guardar', delete: 'Eliminar', close: 'Cerrar', unknown: 'Desconocido', of: 'de', hide: 'Ocultar' },
    units: { tin: 'lata', tinPlural: 'latas', mm: 'mm', inches: 'pulgadas' },
    pipesPage: {
      myPipes: 'Mis Pipas',
      pipes: 'pipas',
      totalValue: 'valor total',
      quickSearchAdd: 'Búsqueda Rápida y Agregar',
      quickSearch: 'Agregar Rápido',
      ...
      startCollection: 'Comience Su Colección',
      noPipesFound: 'No Se Encontraron Pipas',
      startCollectionDesc: 'Comience su viaje con pipas agregando su primera pieza.',
      noMatchSearch: 'Ninguna pipa coincide con su búsqueda',
      noMatchFilters: 'Ninguna pipa coincide con sus filtros actuales.',
      addFirstPipe: 'Agregar Primera Pipa',
    ...
    tobaccoPage: {
      ...
      buildCellar: 'Construya Su Bodega',
      noBlendsFound: 'No Se Encontraron Mezclas',
      buildCellarDesc: 'Comience su bodega agregando su primera mezcla.',
      noMatchSearch: 'Ninguna mezcla coincide con su búsqueda',
      noMatchFilters: 'Ninguna mezcla coincide con sus filtros actuales.',
      addFirstBlend: 'Agregar Primera Mezcla',
      editBlend: 'Editar Mezcla',
      addNewBlend: 'Agregar Nueva Mezcla',
      failedToAddBlend: 'Error al agregar mezcla',
      successfullyUpdated: 'Mezclas actualizadas exitosamente',
