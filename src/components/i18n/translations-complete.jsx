...
export const translationsComplete = {
  en: {
    ...
    tobacconist: {
      ...
      pairingMatrixTooltip: 'AI-generated optimal pipe and tobacco pairings from your collection',
      undo: 'Undo',
      collectionOptimizationTitle: 'Collection Optimization',
      collectionOptimizationTooltip: 'Get strategic recommendations for specializing your pipes and identifying collection gaps',
      breakInSchedules: 'Break-In Schedules',
      breakInSchedulesTooltip: 'AI-generated break-in plans for new pipes with tobacco progression',
      breakInSchedulesDesc: 'Break-in schedules are managed per-pipe on the pipe detail page (with undo/history)',
      ...
      analyzePipeGeometry: 'Analyze Pipe Geometry',
      analyzePipeGeometryTooltip: 'Use AI to classify bowl style, shank shape, and bend from photos',
      total: 'total',
