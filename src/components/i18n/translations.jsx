...
export const translations = {
  en: {
    ...
    subscription: {
      ...
      trialEndedBody: "Subscribe to continue accessing premium features, or continue with free access.",
  ...
  es: {
    ...
    subscription: {
      ...
      trialEndedBody: "Suscríbete para continuar accediendo a funciones premium, o continúa con acceso gratuito.",
  ...
  de: {
    ...
    nav: {
      ...
      subscriptionSupport: "Abo-Support",
    ...
    auth: {
      loginPrompt: "Bitte melde dich an, um fortzufahren",
      login: "Anmelden",
    },

    subscription: {
      trialEndedTitle: "Deine Testphase ist beendet",
      trialEndedBody: "Abonniere, um weiterhin auf Premium-Funktionen zuzugreifen, oder fahre mit kostenlosem Zugriff fort.",
  ...
  ja: {
    ...
    subscription: {
      ...
      trialEndedBody: "プレミアム機能を利用し続けるにはサブスクライブしてください。または無料でご利用いただけます。",
      continueFree: "無料で続ける",
      subscribe: "サブスクライブ",
    },
  },
