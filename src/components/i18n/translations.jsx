...
export const translations = {
  en: {
    ageGate: {
      ...
      // Updated disclaimer as per outline
      disclaimer: "This app is a collection tool for pipe enthusiasts.",
      confirmAge: "I confirm I am of legal age",
    },

    search: {
      trigger: "Search", // No change as per outline
    ...
    home: {
      title: "Pipe & Tobacco Collection", // No change as per outline
      subtitle:
  ...
  es: {
    ...
    search: {
      trigger: "Buscar", // No change as per outline
  ...
  de: {
    ...
    search: {
      trigger: "Suchen", // No change as per outline
  ...
  ja: {
    ...
    search: {
      trigger: "検索", // No change as per outline
      openAria: "検索を開く",
      hintTitle: "入力して検索",
