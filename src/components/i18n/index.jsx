...
export const translations = Object.fromEntries(Object.entries(rawLocales).map(([lang, pack]) => {
  // Apply locale-specific translations first (ui + docs overrides), then fall back to English CRITICAL_FALLBACKS last.
  // This ensures translated .ui.jsx values are never blocked by the English fallback strings.
