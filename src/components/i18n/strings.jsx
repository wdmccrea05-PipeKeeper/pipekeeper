export const STRINGS = {
  ...
  ja: {
    ...
    subscription: {
       ...
       continueWithPremium: "プレミアムで続行",
       premiumBenefits: "プレミアムの利点",
  ...
  sv: {
    ...
    subscription: {
       ...
       continueWithPremium: "Fortsätt med Premium",
       premiumBenefits: "Premium Fördelar",
       cancelAnytime: "Avbryt när som helst",
       dataNotAffected: "Dina data påverkas inte",
     },
    smokingLog: {
      usageLog: "Användningslogg",
      totalBowls: "Totalt Bowlar",
      logSession: "Loggning av Session",
    },
    common: {
      back: "Tillbaka",
      loading: "Laddar...",
  ...
  nl: {
    ...
    subscription: {
       ...
       dataNotAffected: "Uw gegevens worden niet beïnvloed",
     },
    smokingLog: {
      usageLog: "Gebruikslogboek",
      totalBowls: "Totaal Bowlen",
