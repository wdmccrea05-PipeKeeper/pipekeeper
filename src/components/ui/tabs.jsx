...
const TabsList = React.forwardRef(function TabsList(
  ...
  return (
    <TabsPrimitive.List
      ref={ref}
      className={cn(
        "inline-flex h-10 items-center justify-center rounded-lg gap-1 p-1 text-[#E0D8C8]/70 border border-[#E0D8C8]/15 bg-white/5",
        className
      )}
      {...props}
    />
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[state=active]:bg-[#A35C5C] data-[state=active]:text-[#E0D8C8] data-[state=active]:shadow-sm",
