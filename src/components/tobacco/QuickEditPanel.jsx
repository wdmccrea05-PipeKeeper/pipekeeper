...
export default function QuickEditPanel({ selectedCount, onUpdate, onCancel, isLoading, selectedBlends }) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-[linear-gradient(180deg,rgba(58,40,29,0.98),rgba(30,21,15,1))] border-t-2 border-[#B08958] shadow-2xl text-[#F3E8D4]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <form onSubmit={handleSubmit}>
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg font-semibold text-[#F3E8D4]">
