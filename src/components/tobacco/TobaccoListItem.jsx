        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-wrap gap-2 mb-2">
              {agingRec && (
                <Badge className={`hidden sm:inline-flex ${agingColorClass} border text-xs font-medium`}>
                  {agingRec.message}
                </Badge>
              )}
              {blend.blend_type && (
              ...
              {blend.cut && (
               <Badge variant="secondary" className="hidden sm:inline-flex bg-amber-700 text-amber-100 border-amber-600/50 text-xs">
                 {blend.cut}
               </Badge>
              )}
